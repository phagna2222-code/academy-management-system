<div wire:ignore.self id="studentModal" class="modal fade" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <form wire:submit.prevent="save" class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    @if($editingId)
                        {{ __('app.actions.edit') }} — {{ __('app.menu.student') }}
                    @else
                        {{ __('app.actions.create') }} — {{ __('app.menu.student') }}
                    @endif
                </h5>
            ...
            <div class="modal-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input wire:model="student_code" type="text" class="form-control" required>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input wire:model="admission_date" type="date" class="form-control">
                    </div>
                    <div class="col-md-6">
                        ...
                        <select wire:model="status" class="form-select">
                            ...
                            <option value="blocked">{{ __('app.status.blocked') }}</option>
                        </select>
                    </div>
                    <div class="col-12">
